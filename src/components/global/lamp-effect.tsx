  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-neutral-300 to-neutral-500 pb-0 bg-clip-text text-center text-3xl  font-medium tracking-tight text-transparent md:text-7xl"
      >
